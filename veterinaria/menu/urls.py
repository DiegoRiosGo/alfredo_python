...
from .views import Inicio,Nosotros,AgendaOnline,Contacto,Login,OlvidoContra,Servicios, crear_reserva, ingreso_contactos, ingreso_registrarse, inicioSesion,olvidarContra,olvidarContra1,modificar,eliminar,paginalogin,Historial_Medico1DatosM,Historial_Medico2DatosD,registroMascota
